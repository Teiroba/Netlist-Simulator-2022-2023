...
and _menhir_goto_list_key_data_ : _menhir_env -> 'ttv_tail -> _menhir_state -> ((string * string) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, (r : ((string * string) list))) = _menhir_stack in
...
# 60 "rom_parser.ml"
            ...
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_1 : ((string * string) list)) = _v in
            Obj.magic _1
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 79 "rom_parser.ml"
         in
        _menhir_goto_list_key_data_ _menhir_env _menhir_stack _menhir_s _v
...
and rom : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> ((string * string) list) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
      _menhir_lexbuf = lexbuf;
