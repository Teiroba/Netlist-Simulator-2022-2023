  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState20 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((((_menhir_stack, _, (xs : (string list))), _, (xs_inlined1 : (string list))), _, (xs_inlined2 : ((string * Netlist_ast.ty) list))), _, (eqs : (Netlist_ast.equation list))) = _menhir_stack in
            let _v : (Netlist_ast.program) = let vars =
              let xs = xs_inlined2 in
              
# 232 "<standard.mly>"
    ( xs )
# 394 "netlist_parser.ml"
...
# 413 "netlist_parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_1 : (Netlist_ast.program)) = _v in
            Obj.magic _1
        | _ ->
            assert (not _menhir_env._menhir_error);
            _menhir_env._menhir_error <- true;
...
and _menhir_goto_separated_nonempty_list_COMMA_var_ : _menhir_env -> 'ttv_tail -> _menhir_state -> ((string * Netlist_ast.ty) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState16 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (xs : ((string * Netlist_ast.ty) list)) = _v in
        let (_menhir_stack, _menhir_s, (x : (string * Netlist_ast.ty))) = _menhir_stack in
        let _v : ((string * Netlist_ast.ty) list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 478 "netlist_parser.ml"
    ...
    | MenhirState9 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (x : ((string * Netlist_ast.ty) list)) = _v in
        let _v : ((string * Netlist_ast.ty) list) = 
# 144 "<standard.mly>"
    ( x )
# 488 "netlist_parser.ml"
         in
...
# 27 "netlist_parser.mly"
       (string)
# 679 "netlist_parser.ml"
                )) = _v in
                let (_menhir_stack, _menhir_s) = _menhir_stack in
                let _v : (Netlist_ast.exp) = 
# 49 "netlist_parser.mly"
               ( Ereg x )
# 685 "netlist_parser.ml"
                 in
                _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                assert (not _menhir_env._menhir_error);
...
# 27 "netlist_parser.mly"
       (string)
# 767 "netlist_parser.ml"
    ))) = _menhir_stack in
    let _v : (string * Netlist_ast.ty) = 
# 70 "netlist_parser.mly"
                      ( (x, ty) )
# 772 "netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
# 26 "netlist_parser.mly"
       (string)
# 817 "netlist_parser.ml"
    )) = _v in
    let _v : (int) = 
# 76 "netlist_parser.mly"
            ( int_of_string c )
# 822 "netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState11 ->
...
and _menhir_goto_loption_separated_nonempty_list_COMMA_var__ : _menhir_env -> 'ttv_tail -> _menhir_state -> ((string * Netlist_ast.ty) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
and _menhir_goto_loption_separated_nonempty_list_COMMA_NAME__ : _menhir_env -> 'ttv_tail -> _menhir_state -> (string list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState1 ->
...
and _menhir_goto_separated_nonempty_list_COMMA_NAME_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (string list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState3 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 27 "netlist_parser.mly"
       (string)
# 1064 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 1069 "netlist_parser.ml"
         in
...
# 27 "netlist_parser.mly"
       (string)
# 1270 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 241 "<standard.mly>"
    ( [ x ] )
# 1275 "netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_NAME_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
